...
# Beachhead - Initial Access Module

## Overview

The beachhead is the first-stage payload in the COMPSCI564 Cyber Effects capstone project. It performs three critical functions:

1. **Pre-Escalation Reconnaissance**: Checks if privilege escalation is viable
2. **Privilege Escalation**: Executes tar wildcard exploit to gain root access
3. **Implant Deployment**: Downloads and executes the C++ implant with elevated privileges
